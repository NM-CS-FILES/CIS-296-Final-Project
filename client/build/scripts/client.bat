...
set CLASSPATH=%APP_HOME%\lib\client-1.0.0.jar;%APP_HOME%\lib\shared-1.0.0.jar


@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" umd.cis296.Client %*
